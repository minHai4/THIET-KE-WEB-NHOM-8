...
function myAccount() {
    ...
    document.getElementById('home-slider').classList.add('hide');
...
function showCategory(category) {
    ...
    if (category.toLowerCase() === 'all') {
        productSearch = productAll; // Trả về toàn bộ sản phẩm
    } else {
...
// Tự động set 'active' theo đường dẫn URL
window.addEventListener("DOMContentLoaded", () => {
    ...
    links.forEach(link => {
        ...
        // Khi người dùng click vào bất kỳ menu nào
...
if (contactForm) {
    contactForm.addEventListener('submit', function (e) {
        ...
        setTimeout(() => {
            ...
            alert('Cảm ơn bạn đã liên hệ với CS Food. Chúng tôi sẽ phản hồi trong thời gian sớm nhất!');
            contactForm.reset();
...
function animateOnScroll() {
    const elements = document.querySelectorAll('.section-title, .section-subtitle, .about-image, .about-content');
    elements.forEach(el => {
